package com.bahri.recipe_project.bootstrap;

import com.bahri.recipe_project.domain.*;
import com.bahri.recipe_project.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMesureRepository unitOfMeasureRepository) {
